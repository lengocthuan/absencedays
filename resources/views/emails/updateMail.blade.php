...
<html>
    <head>
        ...
        .new-color {
        border: 1px solid #0ded29!important;
        }
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <div>
                                                        ...
                                                        @else
                                                        <p>Sau khi nhận phản hồi:<br>
                                                            <b>{{ $inputs['message'] }}</b>
                                                            về thông tin đăng ký lần trước của tôi. Tôi xin phép được cập nhật lại thông tin này như sau.
                                                        </p>
                                                        @endif
                                                        <div class="w3-container w3-border w3-round-xlarge" >
                                                            <p>Nội dung xin nghỉ phép lần trước của tôi như sau:</p>
                                                            <i><p>Thời gian xin nghỉ phép bao gồm: <br>
                                                                <b>{{ $inputs['oldTimeOff'] }}.</b><br>
                                                            </p>
                                                            <p>Lý do: <b>{{ $inputs['oldNote'] }}.<b></p>
                                                            </i>
                                                        </div>
                                                        <br>
                                                        <div class="w3-container new-color w3-round-xlarge">
                                                            <p>Nội dung xin nghỉ phép mới như sau:<br>
                                                                <p>Thời gian xin nghỉ phép bao gồm: <br>
                                                                    <b>{{ $inputs['timeOff'] }}.</b><br>
                                                                </p>
                                                                <p>Lý do: <b>{{ $inputs['note'] }}.</b></p>
                                                            </p>
                                                        </div>
